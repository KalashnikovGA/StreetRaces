...
/**
 * Предельная ширина машины на экране, логические пиксели.
 *
 * Спрайт снят кадром 512 на 256 (assets/render/camera.json), машина занимает
 * в нём около 465 пикселей. На экране с двойной плотностью 200 логических —
 * это 400 физических: спрайт кладётся почти один в один, без растягивания.
 *
 * Крупнее показывать нечего: исходные модели куплены не под витрину, и на
 * двойном увеличении по стыкам панелей вылезают складки, которых на машине
 * нет. Мелко машина читается лучше — как в оригинале.
 */
export const CAR_MAX_WIDTH = 200;
