...
/**
 * Машины, для которых спрайты уже отрендерены. Остальные пока рисуются
 * вектором — §14 велит гнать пайплайн по одной машине, а не пачкой.
 */
export const SPRITE_READY = new Set(['bavar_c40', 'vogel190']);
