...
当 `output_destination=repo_example` 时，输出必须提醒用户遵守 [CONTRIBUTING.md](../CONTRIBUTING.md)。仓库 examples、assets、showcases、eval cases 只能使用 synthetic cases、公开材料或明确 cleared materials。
